        ...
        {icon.slice(0, -1).map((item, index) => (
          <li key={index}>
            <div className={styles["heading-with-4-icon-and-arrows-icons"]}>
              ...
              <FaArrowRight className={styles["heading-with-4-icon-and-arrows-arrow-icon"]} />
            </div>
            <h5>{item.title}</h5>
            <p>{item.desc}</p>
            <FaArrowDown className={styles["heading-with-4-icon-and-arrows-arrow-icon-mobile"]} />
          </li>
        ))}
        <li>
...
HeadingWith4IconsAndArrows.defaultProps = {
